...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn('mb-3 font-semibold', 'data-[variant=legend]:text-base', 'data-[variant=label]:text-sm', className)}
      {...props}
    />
  );
}
...
function FieldGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'group/field-group @container/field-group flex w-full flex-col gap-4 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4 lg:gap-6',
        className,
      )}
      {...props}
    />
...
function FieldLabel({ className, ...props }: React.ComponentProps<typeof Label>) {
  return (
    <Label
      ...
      className={cn(
        'group/field-label peer/field-label flex w-fit gap-2 text-[13px] leading-snug group-data-[disabled=true]/field:opacity-50',
