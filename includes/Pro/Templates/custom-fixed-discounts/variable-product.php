    ...
    <div class="ywhs_wholesale_rules">
        ...
        <div class="ywhs_body">
            ...
            <div class="ywhs_field ywhs_discount_values">
                <input type="hidden" name="yay-wholesale-b2b[discount-type-<?php echo ( esc_html( $index ) ); ?>]" class="ywhs_discount_type" value="<?php echo ( esc_attr( $product_based_discounts['discount_type'] ?? 'fixed' ) ); ?>" />
