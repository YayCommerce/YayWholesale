...
$product_based_discounts = ProductPricingHelper::get_product_based_discount_setting( $variation->ID );
$product_based_access    = ProductAccessHelper::get_product_based_access_restriction( $variation->ID );
?>
            ...
            <div class="ywhs_field">
                ...
                <div class="ywhs_field_inputs_wrapper">
                    <div class="wc-radios ywhs_radios">
                        <label>
                            <input class='ywhs_discount_rule_default' name="yay-wholesale-b2b[discount-rule-<?php echo ( esc_html( $index ) ); ?>]" value="default" type="radio"
                    ...
                    <div class="wc-radios ywhs_radios">
                        <label>
                            <input class='ywhs_discount_rule_custom' name="yay-wholesale-b2b[discount-rule-<?php echo ( esc_html( $index ) ); ?>]" value="custom" type="radio"
            ...
            <div class="ywhs_discount_values">
                <div class="ywhs_field">
                    ...
                    <div class="ywhs_field_inputs_wrapper">
                        <div class="wc-radios ywhs_radios">
                            <label>
                                <input class='ywhs_discount_type_fixed_and_percent' name="yay-wholesale-b2b[discount-type-<?php echo ( esc_html( $index ) ); ?>]" value="by_role" type="radio"
                        ...
                        <div class="wc-radios ywhs_radios">
                            <label>
                                <input class='ywhs_discount_rule_tier' name="yay-wholesale-b2b[discount-type-<?php echo ( esc_html( $index ) ); ?>]" value="tiered" type="radio"
                    ...
                    <table class="ywhs_discount_roles_value">
                        ...
                        <tbody>
                            <?php foreach ( $wholesale_roles as $wholesale_role ) : ?>
                                <?php
                                    $slug                      = $wholesale_role['slug'];
                                    $percent_fixed_wholesalers = $product_based_discounts['discount_by_role']['wholesaler'];
                                    $tiered_wholesalers        = $product_based_discounts['discount_tiered']['wholesaler'];
                                ?>
                                <tr>
                                    ...
                                    <td class="ywhs_volume_tier_cell ywhs_tier_type">
                                        <div class="ywhs_tier_cell">
                                            <div class="ywhs_value_input">
                                                <input
                                                type="number"
                                                id="ywhs_product_tier_base_price_<?php echo ( esc_html( $slug ) ); ?>"
                                                placeholder="<?php esc_attr_e( 'Auto', 'yay-wholesale-b2b' ); ?>"
                                                name="yay-wholesale-b2b[base-tier-price-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $slug ) ); ?>]"
                                                value=<?php echo ( esc_html( $tiered_wholesalers[ $slug ]['base_tier']['price'] ?? $variation_data['_price'][0] ) ); ?>
                                                step="0.01"
                                                min="0"
                                                >
                                        ...
                                        <div class="ywhs_tier_volume_container">
                                            <?php if ( array_key_exists( $slug, $tiered_wholesalers ) ) : ?>
                                                <?php foreach ( $tiered_wholesalers[ $slug ]['tier_list'] as $tier_index => $tier ) : ?>
                                                    ...
                                                    <div class="ywhs_tier_volume">
                                                        <div class="ywhs_tier_from_quantity">
                                                            ...
                                                            <input
                                                            type="number"
                                                            id="ywhs_product_tier_from_quantity_<?php echo ( esc_html( $slug ) ); ?>"
                                                            name="yay-wholesale-b2b[tier-from-quantity-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $slug ) ); ?>][<?php echo( esc_html( $tier_index ) ); ?>]"
                                                        ...
                                                        <div class="ywhs_tier_price">
                                                            ...
                                                            <div class="ywhs_value_input">
                                                                ...
                                                                id="ywhs_product_tier_base_price_<?php echo ( esc_html( $slug ) ); ?>"
                                                                placeholder="<?php esc_attr_e( 'Auto', 'yay-wholesale-b2b' ); ?>"
                                                                name="yay-wholesale-b2b[tier-price-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $slug ) ); ?>][<?php echo( esc_html( $tier_index ) ); ?>]"
                                        ...
                                        <div
                                            ...
                                            data-role="<?php echo ( esc_html( $slug ) ); ?>"
                                            data-variation="<?php echo ( esc_html( $index ) ); ?>"
                                    ...
                                    <td class="ywhs_fixed_rate_type ywhs_tier_base_price_cell">
                                        <div class="ywhs_value_input">
                                            <input type="hidden" class="ywhs_discount_type" name="yay-wholesale-b2b[discount-by-role-types-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $slug ) ); ?>]" value="<?php echo ( esc_html( $percent_fixed_wholesalers[ $slug ]['type'] ?? 'rate' ) ); ?>" />
                                            <input
                                                type="number"
                                                id="ywhs_product_based_value_<?php echo ( esc_html( $slug ) ); ?>"
                                                class="ywhs_discount_value"
                                                name="yay-wholesale-b2b[discount-by-role-val-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $slug ) ); ?>]"
                                                placeholder="<?php esc_attr_e( 'Auto', 'yay-wholesale-b2b' ); ?>"
                                                value=
                                                <?php
                                                        echo ( array_key_exists( $slug, $percent_fixed_wholesalers )
                                                            ? esc_html(
                                                                'fixed' === $percent_fixed_wholesalers[ $slug ]['type']
                                                                    ? $percent_fixed_wholesalers[ $slug ]['fixed']
                                                                    : $percent_fixed_wholesalers[ $slug ]['rate']
                                                            )
                                                            : '' );
                                                ?>
                                                data-rate="<?php echo ( esc_html( $percent_fixed_wholesalers[ $slug ]['rate'] ?? '' ) ); ?>"
                                                data-fixed="<?php echo ( esc_html( $percent_fixed_wholesalers[ $slug ]['fixed'] ?? '' ) ); ?>"
                                                step="0.01"
                                                min="0"
                                                <?php echo ( esc_html( array_key_exists( $slug, $percent_fixed_wholesalers ) && 'rate' === $percent_fixed_wholesalers[ $slug ]['type'] ? 'max=100' : '' ) ); ?>
                                                >
                                            </input>
                                            <div class="ywhs_discount_type_trigger">
                                                <?php echo ( esc_html( array_key_exists( $slug, $percent_fixed_wholesalers ) && 'fixed' === $percent_fixed_wholesalers[ $slug ]['type'] ? get_woocommerce_currency_symbol() : '%' ) ); ?>
                                            </div>
                    ...
                    <div class="wc-radios ywhs_radios">
                        <label>
                            <input
                                ...
                                name="yay-wholesale-b2b[access-rule-<?php echo ( esc_html( $index ) ); ?>]"
                                value="visible-all"
                                type="radio"
                ...
                <div class="ywhs_field">
                    ...
                    <div class="ywhs_field_inputs_wrapper">
                        <div class="wc-radios ywhs_radios">
                            <label>
                                <input
                                    name="yay-wholesale-b2b[access-retailers-<?php echo ( esc_html( $index ) ); ?>]"
                                    value="disabled"
                                    type="radio"
                        ...
                        <div class="wc-radios ywhs_radios">
                            <label>
                                <input
                                    ...
                                    name="yay-wholesale-b2b[access-wholesalers-<?php echo ( esc_html( $index ) ); ?>]"
                                    value="disabled"
                                    type="radio"
                    ...
                    <div class="ywhs_field_inputs_list">
                        <?php foreach ( $wholesale_roles as $wholesale_role ) : ?>
                            ...
                            <div class="wc-radios">
                                <label>
                                    <input
                                        name="yay-wholesale-b2b[access-selected-roles-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $slug ) ); ?>]"
                                        type="checkbox"
                                        <?php echo ( esc_attr( 'enabled' === $product_based_access['wholesalers'] || in_array( $slug, $product_based_access['selected_roles'], true ) ? 'checked' : '' ) ); ?> />
