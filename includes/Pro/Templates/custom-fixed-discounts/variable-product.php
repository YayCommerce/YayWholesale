                            ...
                            <?php foreach ( $wholesale_roles as $wholesale_role ) : ?>
                                <tr>
                                    ...
                                    <td class="ywhs_volume_tier_cell ywhs_tier_type">
                                        <div class="ywhs_tier_cell">
                                            <div class="ywhs_value_input">
                                                ...
                                                name="yay-wholesale-b2b[base-tier-price-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $wholesale_role['slug'] ) ); ?>]"
                                                value=<?php echo ( esc_html( $product_based_discounts['discount_tiered']['wholesaler'][ $wholesale_role['slug'] ]['base_tier']['price'] ?? $variation_data['_price'][0] ) ); ?>
                                                step="0.01"
                                                min="0"
                                                >
                                        ...
                                        <div class="ywhs_tier_volume_container">
                                            <?php if ( array_key_exists( $wholesale_role['slug'], $product_based_discounts['discount_tiered']['wholesaler'] ) ) : ?>
                                                <?php foreach ( $product_based_discounts['discount_tiered']['wholesaler'][ $wholesale_role['slug'] ]['tier_list'] as $tier_index => $tier ) : ?>
                                                    ...
                                                    <div class="ywhs_tier_volume">
                                                        <div class="ywhs_tier_from_quantity">
                                                            ...
                                                            name="yay-wholesale-b2b[tier-from-quantity-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $wholesale_role['slug'] ) ); ?>][<?php echo( esc_html( $tier_index ) ); ?>]"
                                                        ...
                                                        <div class="ywhs_tier_price">
                                                            ...
                                                            <div class="ywhs_value_input">
                                                                ...
                                                                type="number"
                                                                id="ywhs_product_tier_base_price_<?php echo ( esc_html( $wholesale_role['slug'] ) ); ?>"
                                                                name="yay-wholesale-b2b[tier-price-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $wholesale_role['slug'] ) ); ?>][<?php echo( esc_html( $tier_index ) ); ?>]"
                                    ...
                                    <td class="ywhs_fixed_rate_type ywhs_tier_base_price_cell">
                                        <div class="ywhs_value_input">
                                            <input type="hidden" class="ywhs_discount_type" name="yay-wholesale-b2b[discount-by-role-types-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $wholesale_role['slug'] ) ); ?>]" value=<?php echo ( esc_html( $product_based_discounts['discount_by_role']['wholesaler'][ $wholesale_role['slug'] ]['type'] ) ); ?> />
                                            <input
                                                type="number"
                                                id="ywhs_product_based_value_<?php echo ( esc_html( $wholesale_role['slug'] ) ); ?>"
                                                class="ywhs_discount_value"
                                                name="yay-wholesale-b2b[discount-by-role-val-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $wholesale_role['slug'] ) ); ?>]"
                    ...
                    <div class="ywhs_field_inputs_list">
                        <?php foreach ( $wholesale_roles as $wholesale_role ) : ?>
                            <div class="wc-radios">
                                <label>
                                    <input
                                        name="yay-wholesale-b2b[access-selected-roles-<?php echo ( esc_html( $index ) ); ?>][<?php echo ( esc_html( $wholesale_role['slug'] ) ); ?>]"
                                        type="checkbox"
