...
class HooksHelper {
    ...
    public static function remove_price_hooks() {
        remove_filter( 'woocommerce_product_get_price', [ Pricing::get_instance(), 'ywhs_get_price' ], 999 );
        remove_filter( 'woocommerce_product_variation_get_price', [ Pricing::get_instance(), 'ywhs_get_price' ], 999 );
        remove_filter( 'woocommerce_variation_prices_price', [ Pricing::get_instance(), 'ywhs_get_price' ], 999 );
    }
    ...
    public static function remove_sale_price_hooks() {
        remove_filter( 'woocommerce_product_get_sale_price', [ Pricing::get_instance(), 'ywhs_get_sale_price' ], 999 );
        remove_filter( 'woocommerce_product_variation_get_sale_price', [ Pricing::get_instance(), 'ywhs_get_sale_price' ], 999 );
        remove_filter( 'woocommerce_variation_prices_sale_price', [ Pricing::get_instance(), 'ywhs_get_sale_price' ], 999 );
    }
