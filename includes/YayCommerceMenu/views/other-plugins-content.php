        ...
        switch ( $install_status['status'] ) {
            ...
            case 'newer_installed':
                if ( is_plugin_active( $install_status['file'] ) ) {
                    ...
                    $plugin_status = '<span class="plugin-status-inactive" data-plugin-file="' . esc_attr( $install_status['file'] ) . '">Inactive</span>';
                    if ( $compatible_php && $compatible_wp ) {
                        $button_text = __( 'Activate', 'yay-wholesale-b2b' );
                        /* translators: %s: Plugin name. */
                        $button_label = _x( 'Activate %s', 'plugin', 'yay-wholesale-b2b' );
                        ...
                        if ( is_network_admin() ) {
                            $button_text = __( 'Network Activate', 'yay-wholesale-b2b' );
                            /* translators: %s: Plugin name. */
                            $button_label = _x( 'Network Activate %s', 'plugin', 'yay-wholesale-b2b' );
