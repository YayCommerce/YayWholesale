...
use Yay_Wholesale\Helpers\TranslateHelper;
...
class Settings {
	...
	protected function __construct() {
		...
		add_action( 'admin_menu', array( $this, 'admin_menu' ), YAY_WHOLESALE_MENU_PRIORITY );

		add_filter( 'plugin_action_links_' . YAY_WHOLESALE_BASE_NAME, array( $this, 'addActionLinks' ) );
	...
	public function register_post_type() {
		...
		$yay_wholesale_post_type = Helper::get_post_type();
		$args                    = array(
			'labels'            => $labels,
	...
	public function admin_menu() {
		...
		add_submenu_page( 'yaycommerce', $page_title, $menu_title, 'manage_woocommerce', 'yay_wholesale', array( $this, 'submenu_page_callback' ), 0 );
	}
	...
	public function admin_enqueue_scripts( $hook_suffix ) {
		...
		$allow_hook_suffixes = array( 'yaycommerce_page_yay_wholesale' );
