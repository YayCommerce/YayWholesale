...
namespace YayWholesaleB2BScoped\YayCommerce\AdminShell;

use YayWholesaleB2BScoped\YayCommerce\AdminShell\Contracts\AddonHostAdapter;
...
use YayWholesaleB2BScoped\YayCommerce\AdminShell\License\LicenseHandler;
use YayWholesaleB2BScoped\YayCommerce\AdminShell\License\PluginInfoFactory;
use YayWholesaleB2BScoped\YayCommerce\AdminShell\Menu\ExternalPluginMenuAdapter;
...
class AdminShell {
    ...
    private static function register_plugin_links( PluginMenuAdapter $adapter ): void {
        ...
        add_filter(
            ...
            function ( array $links ) use ( $adapter ) {
                $new       = [];
        ...
        add_filter(
            'plugin_row_meta',
            function ( array $meta, string $file ) use ( $adapter, $basename ) {
                if ( $file !== $basename ) {
                    return $meta;
                }
